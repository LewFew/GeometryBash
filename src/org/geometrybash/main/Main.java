	...
	public void initialize() {
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				Image q = new ImageIcon(Resources.getPath(information[1])).getImage();
		...
		try {
			...
			FileReader fileReader = new FileReader(Resources.getPath("resources/maps/MapList.txt"));
			BufferedReader bufferedReader = new BufferedReader(fileReader);
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				FileReader fr2 = new FileReader(Resources.getPath(information[1]));
