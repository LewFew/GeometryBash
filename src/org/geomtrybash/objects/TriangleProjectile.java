...
public class TriangleProjectile extends Attack {
	...
	public void render(Graphics g) {
		...
		AffineTransform rotate = AffineTransform.getRotateInstance(Math.toRadians(velocity.getTheta() + 90), (position.getX() + width/2) * prev.getScaleX(), (position.getY() + height/2) * prev.getScaleY());
		
		rotate.scale(prev.getScaleX(), prev.getScaleY());
